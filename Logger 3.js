function sumRowsBySpendConfigurationAndDate() {
  ...
  // Log the Spend Configuration and month sums
  for (var key in spendConfigMonthSums) {
    ...
    Logger.log("Spend Configuration: " + spendConfig + ", Year: " + year + ", Month: " + (month + 1) + ", Total Amount: " + spendConfigMonthSums[key]);
  }
}
