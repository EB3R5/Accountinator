...
creds = ServiceAccountCredentials.from_json_keyfile_name('path/to/your/service-account-file.json', scope)  # Replace with the path to your downloaded JSON file
